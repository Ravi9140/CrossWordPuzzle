...
int main()
{
	...
	char dictionary[][15]={"start","smooth","slow","about","boxing","account","axis","accept","attire","tantrums","india",
	"jafer","drama","queen","yacht","zebra","accent","decision","expect","except","average","random","forest",
